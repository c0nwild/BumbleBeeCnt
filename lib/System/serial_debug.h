...
#define DEBUG_ID_ST_POWER_MANAGEMENT (0x110)
#define DEBUG_ID_ST_WRITE_TO_SD (0x120)
#define DEBUG_ID_ST_PREPARE_SLEEP (0x140)
#define DEBUG_ID_ST_GOTO_SLEEP (0x180)
#define DEBUG_ID_ST_ERROR (0x200)
